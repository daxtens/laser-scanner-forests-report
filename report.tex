...
software elements --- should be a key goal.\footnote{I also
  ...
  key details --- and turned out to be wrong. \todo{citation?}}
...
\todo{move stuff over from various-ros-packages}
...
candidates are the Raspberry Pi (\todo{cite}) and the BeagleBone Black
(\todo{cite}). Both of these boards run on 5V, consume vastly less
...
\item[I/O] The LP-170C uses a CF card, the Raspberry Pi uses a SD
  ...
  to be problematic on the LP-170C (see Section~\todo{ref}), and
